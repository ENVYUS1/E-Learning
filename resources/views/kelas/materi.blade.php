				...
				@else
					<div class="row mt-5">
						<div class="col-12 ml-auto mr-auto text-center">
							<img src="/template/assets/img/draws/undraw_empty_xct9.svg" width="50%" alt="">
							<br>
				...
				<div class="modal-body no-bd">
					...
					<div class="form-group form-show-validation row mt-2">
						...
						<div class="col-lg-7 col-md-12 col-sm-12">
							<input type="text" name="nama" class="form-control" required placeholder="Masukkan Nama Materi" aria-required="true">
						</div>
					</div>
					<div class="form-group form-show-validation row mt-2">
						...
						<div class="col-lg-7 col-md-12 col-sm-12">
							<textarea name="keterangan" class="form-control" rows="3" required placeholder="Masukkan Nama Materi" aria-required="true"></textarea>
						</div>
					</div>
					<div class="form-group form-show-validation row mt-2">
