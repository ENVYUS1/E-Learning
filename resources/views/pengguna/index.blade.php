...
<div class="page-inner">
	<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
		...
		<div class="ml-md-auto py-2 mb-2 py-md-0">
			<a href="#" class="btn btn-success btn-round" onclick="modal_pengguna()"><i class="fas fa-bullhorn"></i> Tambah</a>
		</div>
	</div>
		...
		<div class="modal-dialog modal-lg" pengguna="document">
			<div class="modal-content">
				<div class="modal-header no-bd" >
					<div class="card-title"><i class="fas fa-bullhorn"></i> Tambah Pengguna</div>
				...
				<form id="form-pengguna">
					...
					<div class="modal-body">
						...
						<div class="form-group form-show-validation row">
							...
							<div class="col-lg-6 col-md-12 col-sm-12">
								<input type="email" name="email" class="form-control" required="" placeholder="Masukkan Nomor Telepon">
							</div>
						</div>
						<br>
