                ...
                @foreach($data as $quote)
                    ...
                    <div class="item">
                        <div class="avatar avatar-xxl">
                            <img src="template/assets/img/tokoh/{{ $quote["foto"] }}" alt="..." class="avatar-img rounded-circle">
                        </div>
                        <h1 class="title fw-bold text-warning mb-3" style="font-family: 'Lobster', cursive;">{{ $quote["nama"] }}</h1>
                        <p class="text-white" style="font-size: 20px">{{ $quote["text_quote"] }}</p>
                    </div>
            ...
            <div class="container container-login container-transparent animated fadeIn">
                ...
                <div class="login-form">
                    ...
                    <div class="form-group form-action-d-flex mb-3">
                        ...
                        <a href="#" class="btn btn-warning col-md-5 float-right mt-3 mt-sm-0 fw-bold">Sign In</a>
                    </div>
                </div>
            </div>
        </div>
